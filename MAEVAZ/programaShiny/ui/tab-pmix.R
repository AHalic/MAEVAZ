            ...
            sidebarPanel (
              ...
              br(),
                                ...
                                div(id = "parametros_PMIX",
                                    selectizeInput("estacoes",label = "Escolha a Estação",choices=""),
                                    hr (),
                                    radioButtons ("tipo", label = "Estimação de parâmetros",
                                    ...
                                    shinyjs::hidden(
                                      div(id = "parametros_ag",
                                          ...
                                          sliderInput ("nPop", label = "Tamanho da população", min = 10, max = 100, value = 50, width = "100%"),
                                ...
                                fluidRow( 
                                  column(6,actionButton ("iniciar", "Iniciar", class = "btn-primary")),
